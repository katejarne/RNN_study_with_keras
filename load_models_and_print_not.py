...
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_not/09-10-18_not_print"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_not/09-13-18_not_print"
r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_not/2019-04-01/orto/weights_not_0_N_50_gap_20/aca"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_not/09-13-18_not"
...
for root, sub, files in os.walk(r_dir):
    ...
    for i,f in enumerate(files):
       ...
       plt.savefig("plots_not/autoval_"+str(i)+"_"+str(f)+"_"+str(peso_mask)+"_.png",dpi=200)
       plt.close()
       ...
       plt.xlabel('Unit',fontsize = 20)
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_not/weight_bias_"+str(i)+"_0.png",dpi=200)
       plt.close()
       '''
       ...
       if i==0:
           ...
           plt.title('Histogram Weights after \"Not\" learning', fontsize = 18)
       ...
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_not/weight_histo_"+str(i)+"_0.png",dpi=200)
       plt.close()
      ...
      #################################### Conectivity matrix: positive or excitatory weights ###################################
       ...
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_not/Pos_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       plt.xlabel('Unit [j]',fontsize = 16)
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_not/Neg_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
...
plt.xlabel('Unit [j]',fontsize = 16)
#plt.legend(fontsize= 'medium',loc=1)
plt.savefig("plots_not/Diff_conection_matrix_"+str(i)+"_0.png",dpi=200)
plt.close()
'''
