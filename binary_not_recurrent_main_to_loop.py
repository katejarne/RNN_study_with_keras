...
def and_fun(t,N_rec,base,base_plot):
    ...
    model = Sequential()
    model.add(SimpleRNN(units=N_rec,return_sequences=True, input_shape=(None, 1), kernel_initializer='glorot_uniform',      recurrent_initializer= pepe ,activation='tanh',use_bias=True))
