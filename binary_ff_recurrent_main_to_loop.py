...
def and_fun(t,N_rec,base,base_plot):
    ...
    sample_size      = 25050#8242 # (2^11 samples +50 for testing its a good value 2^13 +50 is better)
    epochs           = 20
    #N_rec            = 50 #100
    p_connect        = 0.9
    ...
    x_train,y_train,seq_dur, mask = generate_data_set(sample_size,mem_gap) #time loop
    ...
    # Saving weigths
    filepath       = base+'/ff_weights-{epoch:02d}.hdf5'
    ...
    for ii in np.arange(10):
        ...
        figname =  base_plot+"/data_set_ff_sample_trained.png" 
