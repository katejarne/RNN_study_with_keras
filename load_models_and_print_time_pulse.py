...
from print_status_1_inputs import *
...
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_pulse/09-10-18_pulse_print"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_pulse/09-14-18_pulse_to_print"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_pulse/09-14-18_pulse"
plot_dir="plots_pulse"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_pulse/bolsa"
r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_pulse/2019-04-01/orto-50-con-ruido/weights_pulse_5_N_50_gap_20/aca"
...
for root, sub, files in os.walk(r_dir):
    ...
    for i,f in enumerate(files):
       ...
       plt.savefig("plots_pulse/autoval_"+str(i)+"_"+str(f)+"_0.png",dpi=200)
       plt.close()
...
'''
       ...
       plt.xlabel('Unit',fontsize = 20)
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_pulse/weight_bias_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       if i==0:
           ...
           plt.title('Histogram Weights after \"time pulse\" learning task', fontsize = 18)
       ...
       plt.ylim([0,3.5])
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_pulse/weight_histo_"+str(i)+"_0.png",dpi=200)
       plt.close()
      ...
      #################################### Conectivity matrix: positive or excitatory weights ###################################
       ...
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_pulse/Pos_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       plt.xlabel('Unit [j]',fontsize = 16)
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_pulse/Neg_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
      ...
      # Sparsity
       ...
       figname =plot_dir+"/data_set_and_sample_trained.png" 
...
plt.xlabel('Unit [j]',fontsize = 16)
#plt.legend(fontsize= 'medium',loc=1)
plt.savefig("plots_pulse/Diff_conection_matrix_"+str(i)+"_0.png",dpi=200)
plt.close()
'''
