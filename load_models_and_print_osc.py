...
x_train, y_train,y_train_ ,mask,seq_dur,x,frec  = generate_trials(sample_size,mem_gap) 
...
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_osc/09-10-18_osc_print"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_osc/weights-09-14-18_to_print"

#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_osc/weights-09-14-18"
r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_osc/bolsa"
...
for root, sub, files in os.walk(r_dir):
    ...
    for i,f in enumerate(files):
       ...
       plt.scatter(w.real,w.imag,color="r",label="Eigenvalue spectrum\n Total of: "+str(len(w.real))+" values")
       plt.xlabel('Real part',fontsize = 20)
       plt.ylabel('Imaginary part',fontsize = 20)
       plt.legend(fontsize= 'large',loc=1)
       plt.savefig("plots_osc/autoval_"+str(i)+"_"+str(f)+"_0.png",dpi=200)
       plt.close()
...
'''
       ...
       plt.xlabel('Unit',fontsize = 20)
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_osc/weight_bias_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       if i==0:
           ...
           plt.title('Histogram Weights after \"Oscilatory Task\" learning', fontsize = 18)
       ...
       plt.ylim([0,3.5])
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_osc/weight_histo_"+str(i)+"_0.png",dpi=200)
       plt.close()
      ...
      #################################### Conectivity matrix: positive or excitatory weights ###################################
       ...
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_osc/Pos_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       plt.xlabel('Unit [j]',fontsize = 16)
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_osc/Neg_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
       # Sparsity
       ...
       fig.suptitle("\"Oscilatory\" Data Set Trainined Output \n (amplitude in arb. units time in mSec)",fontsize = 20)
...
plt.xlabel('Unit [j]',fontsize = 16)
#plt.legend(fontsize= 'medium',loc=1)
plt.savefig("plots_osc/Diff_conection_matrix_"+str(i)+"_0.png",dpi=200)
plt.close()
'''
