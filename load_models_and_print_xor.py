...
sample_size_3       = 5
mem_gap             = 20
sample_size         = 20 # Data set to print some results
lista_distancia_all =[]
...
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/09-10-18_xor_print"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/09-13-18_xor_print"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/09-13-18_xor"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/weights_xor_20_N/1"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/bolsa"
#r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/2019-04-01/orto/weights_xor_2_N_50_gap_20/aca"
r_dir="/home/kathy/Escritorio/Neuronal_networks/my_code/weights_xor/2019-04-01/ran_nor/weights_xor_0_N_50_gap_20/aca"
...
for root, sub, files in os.walk(r_dir):
    ...
    for i,f in enumerate(files):
       ...
       plt.savefig("plots_xor/autoval_"+str(i)+"_"+str(f)+"_"+str(peso_mask)+"_.png",dpi=200)
       plt.close()
...
'''
       ...
       plt.xlabel('Unit',fontsize = 20)
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_xor/weight_bias_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       if i==0:
           ...
           plt.title('Histogram Weights after \"Xor\" learning', fontsize = 18)
       ...
       plt.ylim([0,3.5])
       plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_xor/weight_histo_"+str(i)+"_0.png",dpi=200)
       plt.close()
      ...
      #################################### Conectivity matrix: positive or excitatory weights ###################################
       ...
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_xor/Pos_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
       ...
       plt.xlabel('Unit [j]',fontsize = 16)
       #plt.legend(fontsize= 'medium',loc=1)
       plt.savefig("plots_xor/Neg_conection_matrix_"+str(i)+"_0.png",dpi=200)
       plt.close()
       # Sparsity
...
plt.xlabel('Unit [j]',fontsize = 16)
#plt.legend(fontsize= 'medium',loc=1)
plt.savefig("plots_xor/Diff_conection_matrix_"+str(i)+"_0.png",dpi=200)
plt.close()
'''
